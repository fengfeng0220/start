...
//int main()
//{
//	int a = 10;//局部变量-放在大括号内部的就是拒不变量
//	//局部变量和全局变量名字冲突的时候，局部优先
//	printf("%d",a);//此个a会输出什么？-10
//	{
//		int a = 1;//此个a为局部变量
//	}
//	return 0;
...
//	//年龄
//	short age = 20;
//	float weiget = 55.6f;//直接写出的浮点数默认类型是double
//	char ch = 'a';//''字符  ""字符串 
//
//	return 0;
//	//一个汉字占两个字符
